...
## Project Structure
    ...
    ├── test_app_docu_manag_38102  # Django project configurations
...
1. Clone this repo and `cd test_app_docu_manag_38102`
...
2. Clone this repo and `cd test_app_docu_manag_38102`
